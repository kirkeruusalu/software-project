...
class TestSubjectRepository(unittest.TestCase):
    def setUp(self):
        ...
        self.user_kirke2 = User("kirke2", "password456")
    ...
    def test_add_multiple_subjects_for_same_user(self):
        ...
        math_found = self.test_repository.find_subject_by_name(self.user_kirke, self.subject_math.name)
        science_found = self.test_repository.find_subject_by_name(self.user_kirke, self.subject_science.name)
    ...
    def test_add_same_subject_for_different_users(self):
        ...
        kirke_subject = self.test_repository.find_subject_by_name(self.user_kirke, self.subject_math.name)
        kirke2_subject = self.test_repository.find_subject_by_name(self.user_kirke2, self.subject_math.name)
    ...
    def test_delete_all(self):
        ...
        self.test_repository.delete_all()
        kirke_subject = self.test_repository.find_subject_by_name(self.user_kirke, self.subject_math.name)
        kirke2_subject = self.test_repository.find_subject_by_name(self.user_kirke2, self.subject_science.name)
