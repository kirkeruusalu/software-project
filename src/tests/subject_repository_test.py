...
class TestSubjectRepository(unittest.TestCase):
    ...
    def test_add_subject(self):
        ...
        found_subject = self.test_repository.find_subject(self.user_kirke, self.subject_math)
    ...
    def test_add_multiple_subjects_for_same_user(self):
        ...
        math_found = self.test_repository.find_subject(self.user_kirke, self.subject_math)
        science_found = self.test_repository.find_subject(self.user_kirke, self.subject_science)
    ...
    def test_add_same_subject_for_different_users(self):
        ...
        kirke2_subject = self.test_repository.find_subject(self.user_kirke2, self.subject_math)
